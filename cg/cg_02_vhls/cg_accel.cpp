...
#pragma HLS PIPELINE
			...
			DATA_TYPE tmp = a_local_1*p_tmp_1 + a_local_2*p_tmp_2 + a_local_3*p_tmp_3 + a_local_4*p_tmp_4 + a_local_4*p_tmp_4;
			q_local += tmp;
...
#pragma HLS PIPELINE
		...
		DATA_TYPE q_tmp = q_fifo_1.read();
		DATA_TYPE p_tmp = p_fifo_1.read();
