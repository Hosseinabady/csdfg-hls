...
int main(int argc, char *argv[])
{
	...
	if ( (x_hw=(DATA_TYPE *)malloc(M_MAX*sizeof(DATA_TYPE))) == NULL )
		perror("memory allocation for c");
	if ( (d_hw=(DATA_TYPE *)malloc(M_MAX*sizeof(DATA_TYPE))) == NULL )
		perror("memory allocation for a");
	...
	hv((DATA_TYPE_WB*)y_hw,  (DATA_TYPE_WB*)A_hw,  (DATA_TYPE_WB*)x_hw, (DATA_TYPE_WB*)d_hw, m, n);
	//hv((DATA_TYPE*)y_hw,  (DATA_TYPE*)A_hw,  (DATA_TYPE*)x_hw, (DATA_TYPE*)d_hw, m, n);
